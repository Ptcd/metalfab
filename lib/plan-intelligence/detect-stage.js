...
const FILENAME_MARKERS = [
  ...
  { stage: 'final_cd',    re: /\b(?:final|issued[\s_-]?for[\s_-]?(?:construction|bid|permit)|ifc\b|ifb\b|construction[\s_-]?documents?|cd[\s_-]?set|100[\s_-]?%|bid[\s_-]?permit|permit[\s_-]?set|bidding[\s_-]?set)/i },
];
