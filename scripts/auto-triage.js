...
function isDefinitelyNotMetalFab(title, desc) {
  ...
  const notMetalFab = [
    ...
    // Round 6 — Milwaukee County bulk cleanup
    'fuel tank', 'underground fuel', 'fuel farm',
    'breakwater', 'shoreline work', 'shoreline design',
    'habitat restoration', 'parkway sections',
    'dump site investigation', 'dump site',
    'sediment abatement', 'sediment',
    'flushing channel',
    'flood mitigation', 'flood control',
    'bluff repair', 'lake michigan bluff',
    'revetment', 'reintegration center',
    'health clinic', 'on-site health',
    'court renovation', 'family court',
    'court improvement',
    'skills training', 'letter skills',
    'personal development program', 'group based',
    'physician and medical', 'detention physician',
    'housing supportive', 'housing program',
    'ancillary services', 'open enrollment',
    'outpatient', 'behavioral health',
    'call for artists', 'artist',
    'activation service', 'facility activation',
    'back-up power', 'disaster recovery back',
    'baseball lighting', 'light fixture upgrade', 'lighting upgrade',
    'golf practice', 'golf course', 'golf cart path', 'golf clubhouse',
    'bicycle and pedestrian', 'pedestrian trail', 'bike trail',
    'lift station', 'skate lift',
    'alarm and sprinkler', 'sprinkler system', 'alarm system',
    'expansion joint', 'post-tensioned', 'post tensioned',
    'taxiway rehabilitation', 'taxiway removal', 'taxi lane',
    'ramp rehabilitation', 'ramp strengthening',
    'traffic signal', 'traffic siginal',
    'fire protection system',
    'civil engineering professional', 'architectural professional',
    'mep professional',
    'parking lot revetment',
    'demonstration kitchen',
    'facade repair', 'facade rehabilitation', 'facade upgrade',
    'exterior improvements', 'building exterior',
    'ticketing area remodel',
    'baggage handling', 'baggage system',
    'legal benefit', 'legal service',
    'brokerage', 'real estate',
    'countywide time & material', 'time and material',
    'roadway rehabilitation', 'parkway roadway',
    'park court improvement',
    'lower-level restroom', 'restroom renovation',
    'irrigation replacement', 'irrigation',
    'security systems upgrade',
    'engineering professional service', 'construction management service',
    'owner representative', 'project manager/owner',
    'master plan',
    'geotechnical', 'environmental service',
    'material testing',
    // Professional services / consulting RFPs
    'soq for', 'rfq: milwaukee county', 'rfq:  milwaukee',
    'professional service',
    // Round 7 — more Milwaukee County cleanup
    'oak leaf trail', 'trail extension', 'trail connectivity',
    'zoo front entrance', 'zoo adventure', 'zoo admin', 'rhino exhibit',
    'senior center renovation', 'senior center',
    'rehabilitate bullseye',
    'college avenue', 'arw college',
    'hillview building',
